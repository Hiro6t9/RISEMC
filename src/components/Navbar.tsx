...
const Navbar = () => {
  ...
  return (
    <header className={cn(
      ...
      isScrolled 
        ? "py-3 bg-rise-500/90 backdrop-blur-lg shadow-md" 
        : "py-5 bg-transparent"
    )}>
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <a href="/" className="flex items-center space-x-2">
          <span className="text-2xl font-bold font-minecraft tracking-tight">
            <span className="text-creamy-50">RISE</span>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Button 
            className="bg-white text-rise-500 hover:bg-creamy-100 rounded-full shadow-md"
            onClick={() => {
      ...
      {/* Mobile Menu */}
      <div className={cn(
        "absolute top-full left-0 right-0 bg-rise-500/95 backdrop-blur-sm shadow-lg md:hidden transition-all duration-300 ease-in-out",
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <Button 
            className="w-full bg-white text-rise-500 hover:bg-creamy-100 shadow-md"
            onClick={() => {
              playButtonClickSound();
              window.open('https://store.risemc.fun', '_blank');
            }}
